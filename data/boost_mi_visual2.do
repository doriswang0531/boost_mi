	...
	keep countryname year wss_capex wss_opex ex_ce_watersan ex_te_watersan gdp_usd_cons_2019 capex_wss_to_gdp
	...
	replace ce_wss_mi=. if capex_wss_to_gdp>100
	replace capex_wss_to_gdp=. if capex_wss_to_gdp>100
	sort countryname
	encode countryname, gen(country)	
	summ year
	...
	replace re_wss_mi=. if capex_wss_to_gdp>100
